                        ...
                        @foreach ($halalData as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Tombol Tolak -->
                                    <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#rejectModal" data-id="{{ $data->id_detail }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="acceptForm" method="POST" enctype="multipart/form-data" action="{{ route('updateHalal', ':id_detail') }}">
                    @csrf
                    <div class="mb-3">
...
<script>
    // Handle modal for accepting request
        ...
        form.action = "{{ route('updateHalal', ':id_detail') }}".replace(':id_detail', id_detail)//an placeholder ':id' diganti dengan nilai aktual
    });
